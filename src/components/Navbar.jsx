...
const Navbar = () => {
  ...
  return (
    <nav className={
      `${styles.paddingX} w-full flex items-center py-3 fixed 
    ...
    >
      ...
      <div className='w-full flex justify-between items-center 
        ...
        >
          <img src ={white_logo} alt="white_logo" className='w-12 h-12 object-contain'/>
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>
            Andrei Dascalu &nbsp;
            <span className='sm:block hidden'>| Online Portfolio</span>
          </p>
        </Link>
